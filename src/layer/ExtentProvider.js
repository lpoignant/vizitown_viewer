 ...
 * @param {DomElement} domElement DomElement to compute the minimum extent
 */
 ...
 * @param {THREE.Box3} extent Extent to check
 * @return {boolean} True if the extent is tall enough, false otherwise.
 */
ExtentProvider.ptototype._isExtentHeightValid = function (extent) {
 ...
 *                        Compute an extent large enough if needed.
 *                        You need to specify a domElement for this function to work.
 * @param {THREE.Box3} extent Extent viewed by the camera. Extent is modified.
